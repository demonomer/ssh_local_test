...
на первом этапе планируем входить по паролю пользователя WSL (раскомментируем): 
...
**Итог 1: cервер установлен и запущен, статус "active (running)"**
...
**Итог 2: подключились по ssh с использованием логина и IP-адреса**
...
добавим публичный ключ в authorized_keys (вставим строку в файл)  
и установим права для authorized_keys: 
...
**Итог 4: созданы ключи, публичный ключ добавлен на сервер, входим без пароля**
